// In scope: how the play-too-much caution looks
// Out of scope: deciding whether to show it, holding the balance state

// This goes in an img's src rather than a background image. A data URI in a background arbitrary
// value makes Tailwind's generated CSS die on PostCSS's Unclosed string, breaking the dev server.
// Tailwind scans raw text, so even this note must not spell that class name out.
const iconSrc =
...
/** The play-too-much caution; the caller decides whether it appears */
